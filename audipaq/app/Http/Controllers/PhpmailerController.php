...
class PhpmailerController extends Controller
{
	...
	{
		if (isset($_POST["txtCorreoElectronico"]))
		{
			$correoElectronico=$_POST['txtCorreoElectronico']; 
			$fechaRecuperacion=date("Y-m-d H:i:s", strtotime('+24 hours')); 
			$ConsultaNomPersona = DB::table('persona')
						->select('persona.nombre_persona')
						->where('correo_electronico','=',$correoElectronico)
						->get();
			$idConversion = json_decode(json_encode($ConsultaNomPersona),true);
			$NomPersona = implode($idConversion[0]);
			$this->sendEmail($correoElectronico,$NomPersona);
		}
	}
	public function sendEmail ($correoElectronico, $nombre)
	{
	
		//$template = File::POST('resources/views/template');
       ...
       // $template = str_replace("{{action_url_1}}", 'http:'.URL.'login/newPassword/'.$codigo, $template);
		...
		//$correoElectronico=$solicitar->input('txtCorreoElectronico'); 
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'audipaqapp@gmail.com';   //username
            $mail->Password = 'php@ud1paq';   //password
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;                    //smtp port

            $mail->setFrom('audipaqapp@gmail.com', 'Audipaq');
            $mail->addAddress($correoElectronico, 'Eli');

            $mail->isHTML(true);

            $mail->Subject = 'Recuperación de contraseña - Audipaq';
            $mail->Body = '<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
						<head>
						<meta name="viewport" content="width=device-width, initial-scale=1.0" />
						<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
						<title>Restablecer la contraseña para Audipaq</title>
						</head>
						...
						<span class="preheader" style="box-sizing: border-box; display: none !important; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all; opacity: 0; overflow: hidden; visibility: hidden;">
							Use este enlace para restablecer su contraseña. El enlace solo es válido por 24 horas.
						</span>
						...
						<h1 style="box-sizing: border-box; color: #2F3133; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;" align="left">Hola (nombre_persona), </h1>
						<p style="box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">
							Recientemente solicitó restablecer su contraseña para su cuenta en Audipaq. Use el botón de abajo para reiniciarlo. 
						</p>
						...
						<p style="box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left"> Por razones de seguridad, si no solicitó restablecer la contraseña, ignore este correo electrónico o póngase en contacto con el servicio de asistencia si tiene alguna pregunta. </p>
						...
						<tr>
						<td style="box-sizing: border-box; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; word-break: break-word;">
						<p class="sub" style="box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="left">Si tiene problemas con el botón de arriba, copie y pegue la siguiente URL en su navegador web.</p>
						<p class="sub" style="box-sizing: border-box; color: #74787E; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="left">Aqui-va-la-URL</p>
						</td>
						</tr>
						</table>
						</td>
						...
						<p class="sub align-center" style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="center">©Año Audipaq. Todos los derechos reservados.</p>
						<p class="sub align-center" style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;" align="center">
							<br />Ixtlán del Río, Nayarit, México. 
							<br />300 565 9290
						</p>
						</td>
						</tr>
