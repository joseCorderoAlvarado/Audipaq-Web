...
<div id="agregarActa" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="btnAgregar_Acta" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="modal-body mx-auto" style="width: auto; background-color: #ECEFF1">
                    <div class="row">
                            ...
                            <div class="col-5">
                                <select id="idActa" name="idacta" class="form-control" style="width: auto;">
                                    <option>
                                        Selecciona el acta que quieras agregar
                                    </option>
                                    <option>
                                        ...
                                    </option>
